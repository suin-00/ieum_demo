            ...
            <div className="lg:col-span-3 relative w-full mt-8 lg:mt-0">
              <div className="w-full relative overflow-hidden rounded-2xl shadow-xl">
                <img
                  ...
                  height="1064"
                  alt="IEUM service"
                  src="https://github.com/user-attachments/assets/f8197991-e3d7-4162-af96-0de7a4d3d647"
      ...
      <div className="py-24 lg:py-32 relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            ...
            height="1086"
            alt="IEUM Background"
            src="https://github.com/user-attachments/assets/057fa19f-9811-45ee-b717-c8a0014ef17a"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center relative z-10">
          ...
          <p className="text-white text-lg sm:text-xl font-extrabold tracking-wide">それがIEUMです。</p>
        </div>
      </div>
    </section>
  );
