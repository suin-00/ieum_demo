      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full translate-y-2 sm:translate-y-3 lg:translate-y-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 relative w-full flex items-center justify-center py-6">
            <div className="w-[340px] h-[340px] sm:w-[420px] sm:h-[420px] rounded-full bg-gradient-to-tr from-blue-100/70 via-indigo-50/50 to-yellow-100/40 blur-3xl absolute -z-10" />

            <div
              onMouseEnter={handleTriggerStudentId}
              onClick={handleTriggerStudentId}
              className="relative w-full max-w-[420px] h-[380px] sm:h-[440px] flex items-center justify-center -translate-x-6 sm:-translate-x-9 lg:-translate-x-12 translate-y-2 sm:translate-y-2.5"
            >
              <motion.div
                initial={{ opacity: 0, y: -20, rotate: -4 }}
                animate={{ opacity: 1, y: 0, rotate: -6 }}
                transition={{ duration: 0.8, delay: 0.1 }}
                className="absolute -top-3 sm:-top-5 right-0 sm:-right-4 -rotate-6 z-10 bg-[#B32424] text-white rounded-xl p-3 sm:p-3.5 w-[138px] sm:w-[154px] h-[202px] sm:h-[226px] shadow-2xl border border-red-900/40 select-none overflow-hidden flex flex-col justify-between"
              >
                ...
                <div className="relative z-10 flex flex-col items-center my-auto py-1">
                  ...
                  <div className="text-center font-serif text-[#E5B842] mt-1.5 tracking-[0.2em] pl-0.5">
                    <div className="text-[10px] sm:text-[11px] font-black leading-tight">JAPAN</div>
                    <div className="text-[8px] sm:text-[9px] font-bold leading-tight mt-0.5">PASSPORT</div>
                  </div>
                </div>
                <div className="relative z-10 flex items-center justify-center pb-0.5">
                  <div className="w-5 h-3 border border-[#E5B842] rounded-[1px] flex items-center justify-center relative bg-[#B32424]">
                    <div className="w-full h-[1px] bg-[#E5B842]" />
              ...
              <motion.div
                ...
                className="absolute bottom-10 sm:bottom-14 -right-4 sm:-right-8 rotate-12 z-10 bg-white/95 backdrop-blur-xs rounded-xl p-3 sm:p-3.5 border border-slate-200/90 shadow-lg w-[195px] sm:w-[220px] select-none"
              >
                <div className="flex items-center justify-between border-b border-dashed border-slate-200 pb-1.5 mb-1.5">
                  <div>
                    <span className="text-sm sm:text-base font-black text-[#1E293B]">JPN</span>
                    <span className="text-[10px] text-slate-400 font-bold ml-1">TOKYO</span>
                  </div>
                  <span className="text-xs text-[#23B5D3] font-bold">✈</span>
                  <div>
                    <span className="text-sm sm:text-base font-black text-[#1E293B]">KOR</span>
                    <span className="text-[10px] text-slate-400 font-bold ml-1">ICN</span>
                  </div>
                </div>
                <div className="flex items-center justify-between text-[9px] text-slate-400 font-bold">
                  <span>KE 001 · SEAT 12A</span>
                  <span className="text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded">BOARDING</span>
                </div>
                <div className="mt-2 h-3.5 flex items-center gap-[2px] opacity-70">
                  {[3, 1, 2, 4, 1, 3, 2, 1, 4, 2, 1, 3, 2, 4, 1, 2, 3, 1, 4, 2, 1, 3].map((w, idx) => (
                    <div key={idx} className="h-full bg-slate-800 rounded-xs" style={{ width: `${w}px` }} />
                  ))}
                </div>
              </motion.div>
              ...
              <AnimatePresence>
                {isStudentIdVisible && (
                  ...
                  >
                    <div className="bg-white/75 backdrop-blur-sm rounded-xl p-2 sm:p-2.5 border border-white/80 shadow-xl flex items-center gap-2.5 min-w-[155px] sm:min-w-[172px]">
                      ...
                      <div className="flex flex-col justify-center min-w-0">
                        ...
                        <div className="flex items-center gap-[1.5px] mt-1 opacity-60">
                          {[3, 1, 2, 4, 1, 2, 3, 1, 2, 4, 1, 2].map((w, i) => (
                            <div key={i} className="h-1.5 bg-slate-700 rounded-2xs" style={{ width: `${w}px` }} />
                          ))}
                        </div>
                      </div>
                    </div>
              ...
              <motion.div
                ...
                className="relative z-20 w-[190px] sm:w-[212px] h-[395px] sm:h-[435px] rounded-[2.2rem] sm:rounded-[2.5rem] border-[5px] sm:border-[6px] border-slate-800/95 bg-white shadow-2xl overflow-hidden ml-6 sm:ml-8 mt-10 flex flex-col justify-between"
              >
                <div className="pt-2 px-6 sm:px-7 pb-1.5 bg-white flex items-center justify-between relative select-none border-b border-slate-50">
                  <span className="text-[9px] font-bold text-slate-800 ml-0.5">9:41</span>
                  ...
                  <div className="flex items-center gap-1 mr-0.5">
                    <span className="text-[8px] font-bold text-slate-600">5G</span>
                    <div className="w-3.5 h-1.5 border border-slate-700 rounded-xs p-[1px] flex items-center">
                ...
                <div className="px-3 py-1.5 border-b border-slate-100 bg-slate-50/80 flex items-center justify-between">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] font-extrabold text-[#1E293B]">IEUM Chat</span>
                  </div>
                  <span className="text-[8px] text-slate-400 font-bold bg-slate-200/60 px-1.5 py-0.5 rounded">1:1</span>
                </div>
              ...
              <div className="absolute -bottom-2 sm:-bottom-4 left-0 sm:-left-4 translate-x-4 sm:translate-x-5 animate-float-delayed z-30 select-none">
                <div className="flex flex-col items-center relative">
                  <div className="absolute -top-3.5 -right-2.5 z-20 rotate-12 flex items-end">
                    ...
                    <div className="w-6 h-4 sm:w-6.5 sm:h-4.5 bg-white border border-slate-300 rounded-[1px] shadow-xs relative flex items-center justify-center overflow-hidden p-[1px] mb-0.5">
                  ...
                  <div className="w-5 h-4 sm:h-5 border-x-2 border-t-2 border-slate-700 rounded-t-xs bg-slate-100/40 relative flex justify-center mb-[1px]">
                    <div className="w-3 h-1 bg-slate-800 rounded-xs mt-[1px]" />
                  </div>

                  <div className="w-13 sm:w-15 h-18 sm:h-20 bg-gradient-to-b from-yellow-100 via-yellow-200 to-amber-200 rounded-xl border-2 border-amber-300 shadow-xl relative overflow-hidden flex flex-col justify-between p-1.5">
                    ...
                    <div className="absolute top-2.5 left-1 z-10 -rotate-8 bg-rose-500 text-[5px] font-black text-white px-1 py-[1px] rounded-[2px] shadow-2xs border border-white/70 tracking-tighter">
                      SEOUL
                    </div>
                    <div className="absolute top-7 right-1 z-10 rotate-12 bg-[#196E8A] text-[4.5px] font-extrabold text-white px-1 py-[0.8px] rounded-[2px] shadow-2xs border border-white/70 flex items-center gap-[1px]">
                      <span>KOR</span><span className="text-[4px]">✈</span>
                    </div>
                    ...
                    <div className="relative z-10 flex items-center justify-between mt-auto">
                      <div className="bg-slate-800 text-[6px] font-black text-white px-1 py-0.5 rounded-[2px] shadow-2xs tracking-tighter">
                        IEUM
                      </div>
                      <div className="w-2.5 h-3 bg-white/90 border border-slate-300 rounded-[2px] shadow-2xs flex flex-col items-center justify-center">
                  ...
                  <div className="w-11 sm:w-13 flex justify-between px-1 -mt-[2px]">
